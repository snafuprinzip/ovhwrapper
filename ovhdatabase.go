...
type OVHDatabase struct {
	...
	Endpoints          []DBEndpoint      `json:"endpoints"`
	IpRestrictions     []DBIPRestriction `json:"ipRestrictions"`
	...
	Backups            DBBackups         `json:"backups"`
	Capabilities       DBCapabilities    `json:"capabilities"`
...
func (db OVHDatabase) ID() uuid.UUID { return db.Id }

func (db OVHDatabase) Name() string { return db.Description }

func (db OVHDatabase) DBEngine() string { return db.Engine }

func (db OVHDatabase) DBVersion() string { return db.Version }
